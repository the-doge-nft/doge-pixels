...
export function arrayCrossSetByField<T, L, K extends keyof T, I extends keyof L>(src: T[], search: L[], field: I & K = 'id' as any): T[] {
...
export function arrayFuzzyFilterByKey<T, K extends keyof T>(array: T[], val: any, field: K = 'name' as any): T[] {
    ...
    return array.filter(item => {
        if (typeof item[field] !== "string") {
            console.warn(`Got unexpected value when filtering array, supposed to be 'string' got '${typeof item[field]}`, item, item[field]);
            return false;
        }
...
export function arrayFindIndexByField<T, K extends keyof T>(array: T[], val: any, field: K = 'id' as any): number | null {
