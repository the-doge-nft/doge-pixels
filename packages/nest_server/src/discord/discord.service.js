...
var DiscordService = /** @class */ (function () {
    function DiscordService(config, imageGenerator, ethers, sentryClient) {
        this.config = config;
    ...
    DiscordService.prototype.onModuleInit = function () {
        var _this = this;
        ...
        this.client.once('ready', function () {
            _this.logger.log('Auth success');
        });
    };
    DiscordService.prototype.discordBot = function (_a) {
        var from = _a.from, to = _a.to, tokenId = _a.tokenId;
        return __awaiter(this, void 0, void 0, function () {
            var textContent, image, base64Buffer, channel, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.logger.log("Posting to discord:: (".concat(tokenId, ") ").concat(from, " -> ").concat(to));
                    ...
                    case 2:
                        image = _b.sent();
                        return [4 /*yield*/, image.getBufferAsync('image/png')];
                    case 3:
                        base64Buffer = _b.sent();
                        _b.label = 4;
                    case 4:
                        _b.trys.push([4, 6, , 7]);
                        channel = this.client.channels.cache.get(this.config.get('discord').channelId);
                    ...
                    case 6:
                        e_1 = _b.sent();
                        this.logger.error("error sending image to discord channel: ".concat(e_1.message));
                        this.sentryClient.instance().captureException(e_1);
                        return [3 /*break*/, 7];
    ...
    DiscordService.prototype.DEBUG_TEST = function () {
        return __awaiter(this, arguments, void 0, function () {
            return __generator(this, function (_a) {
                if (this.config.get('isDev')) {
                    return [2 /*return*/, this.discordBot({
    ...
    ], DiscordService.prototype, "discordBot");
