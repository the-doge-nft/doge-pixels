...
export interface ERC20VotesCompInterface extends ethers.utils.Interface {
  functions: {
...
export interface ERC20VotesComp extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20VotesCompInterface;
