...
module.exports = async (args) => {
  ...
  const proxyAddress = "0x0e473d6cb4b848b09c0869b0f67a5c3ae2a1f20e";
  ...
  let currentImplAddress = await upgrades.erc1967.getImplementationAddress(proxyAddress);
  ...
  const res = await upgrades.upgradeProxy(proxyAddress, PXV3);
