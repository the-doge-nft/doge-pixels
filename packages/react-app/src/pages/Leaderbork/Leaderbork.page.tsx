...
const LeaderborkPage = observer(function DogParkPage() {
    ...
    return (
        <Flex w={"full"} flexDir={{base: "column", xl: "row"}}>
            ...
            <Flex flexGrow={1} order={{base: 1, xl: 3}} ml={{base: 0, xl: 10}} display={"flex"}
                  flexDirection={"column"}>
                <Box mb={8}>
                    <Typeahead
                                ...
                                <Flex flexDir={"column"} h={"full"}>
                                    <Flex gap={10} flexDir={{base: "column", md: "row"}}>
                                        {store.previewSelectedPixelId && (
                                            <Box>
                                                <PixelPane size={"md"} pupper={store.previewSelectedPixelId}
                                                           variant={"shadow"}/>
                                            </Box>
                                        )}
                                        <Flex flexDir={"column"} flexGrow={1}>
                                            <Flex flexDir={"column"}>
                                                {store.selectedActivityTransfer && (store.selectedOwnerTab !== SelectedOwnerTab.Wallet || !store.selectedAddress) && (
                                                ...
                                                <Grid templateColumns={"0.75fr 1fr"}>
                                                    ...
                                                    store.selectedActivityTransfer && (
                                                        <>
                                                            ...
                                                            {store.selectedActivityTransferDetails.title !== "Transfer" && (
                                                                <>
                                                                    <Typography
                                                                        variant={TVariant.ComicSans16}>by:</Typography>
                                                                    <Link
                                                                        to={`/leaderbork/${
                                                    ...
                                                    {store.previewSelectedPixelId && (
                                                        <>
                                                            ...
                                                            <Typography
                                                                variant={TVariant.ComicSans16}>{store.previewSelectedPixelId}</Typography>
                                                            ...
                                                            <Typography
                                                                variant={TVariant.ComicSans16}>coords:</Typography>
                                                            <Typography variant={TVariant.ComicSans16}>
                                                    ...
                                                    store.selectedActivityTransfer && (
                                                        <>
                                                            <Typography
                                                                variant={TVariant.ComicSans16}>date:</Typography>
                                                            <Typography variant={TVariant.ComicSans16}
                                                                        overflowWrap={"anywhere"}>
