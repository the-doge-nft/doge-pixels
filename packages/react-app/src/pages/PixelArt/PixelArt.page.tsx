            ...
            <Box>
                <Pane maxH={AppStore.rwd.isMobile ? '520px' : '800px'} maxW={"fit-content"} padding={"2px"}>
                    <Flex flexDirection={"column"} flexGrow={0}>
                        <ArtMenu store={store} />
                        <Box borderTopWidth={'1px'} borderColor={lightOrDarkMode(colorMode, 'black', 'white')} mx={"10px"} mt={1} mb={2} />
                        <GridItem display={"flex"} flexDirection={"row"} flexGrow={0}>
                            <ArtTools store={store} />
                            <ArtCanvas store={store} />
                        </GridItem>
                        <Box borderTopWidth={'1px'} borderColor={lightOrDarkMode(colorMode, 'black', 'white')} mx={"10px"} my={2} mb={1}/>
