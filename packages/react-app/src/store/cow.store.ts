...
class CowStore {
    ...
    BASE_EXPLORER_URL = "https://explorer.cow.fi/mainnet/orders/"
    ...
    public async acceptSimpleQuote(quote: SimpleGetQuoteResponse) {
        ...
        console.log('debug:: signedOrder', signedOrder)
        ...
        console.log('debug:: cowOrder', orderId)
        return orderId
    }
    ...
    public getQuoteForPixels({
                                 ...
                                 pixelCount,
                                 userAddress
                             }: { sellAddress: string, pixelCount: string | number, userAddress: string }) {
