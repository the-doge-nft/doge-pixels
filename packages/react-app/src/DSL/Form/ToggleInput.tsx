...
const ToggleInput = observer(({validate, name, initialValue, label, horizontal, onChange, value}: ToggleInputProps) => {
    ...
    return <Control name={name} isRequired={isRequired} label={label} horizontal={horizontal}>
        <Switch
            {...restInput}
            id={name}
            name={name}
